...
const T = {
  en: {
    ...
    disconnectedWaiting: (name) => `${name} disconnected — waiting 30s...`,
  ...
  ro: {
    ...
    disconnectedWaiting: (name) => `${name} s-a deconectat — așteptăm 30s...`,
  ...
  pt: {
    ...
    disconnectedWaiting: (name) => `${name} desconectado — aguardando 30s...`,
